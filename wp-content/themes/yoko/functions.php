...
function yoko_continue_reading_link() {
	return ' <a href="'. get_permalink() . '">' . __( '+1 Continue reading <span class="meta-nav">&rarr;</span>', 'yoko' ) . '</a>';
}
...
function yoko_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-body">
			...
			<?php printf( __( '%s', 'yoko' ), sprintf( '<cite>%s</cite>', get_comment_author_link() ) ); ?>
